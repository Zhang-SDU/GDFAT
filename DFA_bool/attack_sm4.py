...
engine = sm4Fault.Acquisition(targetbin='./sm4_enc', targetdata='./sm4_enc', goldendata='./sm4_enc.gold', dfa=sm4DA,
                              processinput=processinput, processoutput=processoutput, maxleaf=1, minleaf=1,
                              minleafnail=1, verbose=2, faults_number=600)
